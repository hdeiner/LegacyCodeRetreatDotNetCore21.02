...
namespace TimeTeller
{
    public class ProgramTests
    {
        ...
        {
            Assert.Equal(getFormattedTime(DateTime.Now), Program.GetResult(1, 1, false));
        }

        [Fact]
        public void zuluTimeCurrent()
        {
            Assert.Equal(getFormattedTime(DateTime.UtcNow) + "Z", Program.GetResult(2, 1, false));
        }

        [Fact]
        public void localTimeInWords()
        {
            Assert.Matches("^(\\s|one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|twenty|about|almost|a|little|after|quarter|half|of|past|before|at|night|in|the|morning|afternoon|evening|night)+$", Program.GetResult(1, 2, false));
        }

        [Fact]
        public void zuluTimeInWords()
        {
            Assert.Matches("^(\\s|one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|twenty|about|almost|a|little|after|quarter|half|of|past|before|at|night|in|the|morning|afternoon|evening|night)+Zulu$", Program.GetResult(2, 2, false));
        }
